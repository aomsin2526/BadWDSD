...
mkdir BadWDSD/build
echo -e '#define PICO_TYPE PICO_TYPE_E_PICO\n#define SC_IS_SW 1\n#define XDR_IS_X32 1\n#define IS_EMMC 1\n#define IS_AOMSIN 1' > BadWDSD/build/Config.h || exit 1
./build.sh -DIS_AOMSIN=1 || exit 1

cp -a BadWDSD/build/BadWDSD.uf2 out/BadWDSD_SW_x32_eMMC_Aomsin_Pico.uf2 || exit 1
...
mkdir BadWDSD/build
echo -e '#define PICO_TYPE PICO_TYPE_E_PICO\n#define SC_IS_SW 1\n#define XDR_IS_X32 1\n#define IS_EMMC_ON_NOR 1' > BadWDSD/build/Config.h || exit 1
./build.sh || exit 1

cp -a BadWDSD/build/BadWDSD.uf2 out/BadWDSD_SW_x32_eMMC_on_NOR_Pico.uf2 || exit 1
...
cp -a BadWDSD/build/BadWDSD.uf2 out/BadWDSD_SW_x32_eMMC_RP2040_Zero.uf2 || exit 1
...
cp -a BadWDSD/build/BadWDSD.uf2 out/BadWDSD_SW_x32_eMMC_Pico_W.uf2 || exit 1
