...
#include "Stagex_critical_volatile.c"

//

#include "Stagex_critical_mem.c"
...
{
    return CoreOS2_FindFileEntry(is_emmc ? 0xB0000 : 0xF30000, fileName, outFileFlashOffset, outFileSize);
}
...
{
    uint8_t tid;
    FlashRead(is_emmc ? 0x80875 : 0x2f075, &tid, sizeof(tid));
